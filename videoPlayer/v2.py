...
class VideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.minimize_button = self.create_button("Minimize", "—", self.showNormal)
        self.fullscreen_button = self.create_button("Fullscreen", "⛶", self.toggle_fullscreen_with_style)
        self.close_button = self.create_button("Close", "✕", self.stop)
        ...
        # self.open_button = self.create_button("Open", "📂", self.open_file)
        self.play_button = self.create_button("Play", "▶️", self.play_pause)
        self.mute_button = self.create_button("Mute", "🔇", self.mute_unmute_with_style)
        self.loop_button = self.create_button("Loop", "🔁", self.toggle_loop_with_style)
